...
- **Sidebar sin duplicados**: "Atajos de teclado" y "Guía de uso" vivían en 3 y 2 lugares distintos respectivamente (fila suelta + menú de la barra superior + Ajustes). Sacadas las filas sueltas — siguen 100% disponibles desde Ajustes, el menú "⋯", el atajo `?`, y la paleta de comandos. El footer del sidebar bajó de 7 filas a 5
